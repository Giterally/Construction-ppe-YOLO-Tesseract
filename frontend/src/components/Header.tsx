import buildUkLogo from '../assets/build-uk.webp'
  ...
  return (
    <header className="header">
      <div className="container">
        ...
        <div style={{display: 'flex', gap: 'calc(var(--spacing-unit) * 4)', alignItems: 'flex-start', marginTop: 'calc(var(--spacing-unit) * 4)'}}>
